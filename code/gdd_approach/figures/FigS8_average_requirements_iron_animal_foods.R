...
protein_key <- readRDS(file="data/gdd/processed/GDD_animal_foods_avg.Rds")
...
# Function to derive AR based on ASF
...
protein_ars <- expand.grid(protein=seq(0, 250, 50),
                          sex=c("Males", "Females"),
...
# Export
saveRDS(protein_ars, file="data/gdd/processed/iron_ars_animal_foods.Rds")
...
# Export figure
ggsave(g, filename=file.path(plotdir, "FigS8_average_requirements_iron_animal_foods.png"),
       width=6.5, height=3, units="in", dpi=600)
